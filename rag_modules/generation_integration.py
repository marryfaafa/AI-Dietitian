...
class GenerationIntegrationModule:
    ...
    def generate_health_aware_answer(self, question: str, documents: List[Document],
                                      user_profile: str = "",
                                      compliance_report: str = "") -> str:
        """带健康意识的回答生成（用于个性化膳食建议）"""
        context_parts = []
        for doc in documents:
            content = doc.page_content.strip()
            if content:
        ...
        prompt = f"""作为一个专业的营养膳食顾问，请基于以下信息为用户提供个性化饮食建议。
